...
[View Source](https://github.com/couchbase-examples/vector-search-cookbook/tree/main/huggingface/query_based/hugging_face.ipynb)
...
**Note**: If you want to perform semantic search using the Search Vector Index instead, please take a look at [this alternative tutorial](https://developer.couchbase.com/tutorial-huggingface-couchbase-vector-search-with-search-vector-index).
...
For more information on Hyperscale and Composite Vector Indexes, see [Couchbase Vector Index Documentation](https://docs.couchbase.com/cloud/vector-index/use-vector-indexes.html).
...
4. **Indexing**: The vectors are indexed using our Hyperscale Vector Index for efficient similarity search
