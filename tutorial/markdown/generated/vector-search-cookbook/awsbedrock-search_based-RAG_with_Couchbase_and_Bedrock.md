...
[View Source](https://github.com/couchbase-examples/vector-search-cookbook/tree/main/awsbedrock/search_based/RAG_with_Couchbase_and_Bedrock.ipynb)

## Introduction

In this guide, we will walk you through building a powerful semantic search engine using Couchbase as the backend database and [Amazon Bedrock](https://aws.amazon.com/bedrock/) as both the embedding and language model provider. Semantic search goes beyond simple keyword matching by understanding the context and meaning behind the words in a query, making it an essential tool for applications that require intelligent information retrieval. This tutorial is designed to be beginner-friendly, with clear, step-by-step instructions that will equip you with the knowledge to create a fully functional semantic search system using the Search Vector Index from scratch. Alternatively if you want to perform semantic search using the Hyperscale or Composite Vector Index, please take a look at [this.](https://developer.couchbase.com/tutorial-aws-bedrock-couchbase-rag-with-hyperscale-or-composite-vector-index)

## How to run this tutorial

This tutorial is available as a Jupyter Notebook (`.ipynb` file) that you can run interactively. You can access the original notebook [here](https://github.com/couchbase-examples/vector-search-cookbook/blob/main/awsbedrock/search_based/RAG_with_Couchbase_and_Bedrock.ipynb).
...
```
    ...
    2026-02-03 14:56:56,987 - INFO - Successfully connected to Couchbase
...
```
    ...
    2026-02-03 14:56:57,001 - INFO - Bucket 'vector-search-testing' exists.
    2026-02-03 14:56:57,005 - INFO - Collection 'bedrock' already exists. Skipping creation.
    2026-02-03 14:56:59,016 - INFO - Primary index present or created successfully.
    2026-02-03 14:56:59,036 - INFO - All documents cleared from the collection.
    2026-02-03 14:56:59,037 - INFO - Bucket 'vector-search-testing' exists.
    2026-02-03 14:56:59,040 - INFO - Collection 'cache' already exists. Skipping creation.
    2026-02-03 14:57:01,048 - INFO - Primary index present or created successfully.
    2026-02-03 14:57:01,051 - INFO - All documents cleared from the collection.





    <couchbase.collection.Collection at 0x1215c9af0>
...
```
    ...
    2026-02-03 14:57:01,064 - INFO - Index 'vector_search_bedrock' found
    2026-02-03 14:57:01,075 - INFO - Index 'vector_search_bedrock' already exists. Skipping creation/update.


## Creating Bedrock Embeddings

Embeddings are at the heart of semantic search. They are numerical representations of text that capture the semantic meaning of the words and phrases. We'll use Amazon Bedrock's Titan Embedding model for generating embeddings.

### Using Amazon Bedrock Models

Amazon Bedrock provides access to multiple foundation model families:

- **Titan Embeddings**: For converting text into vector representations (still supported)
- **Nova Models**: Next-generation text models for natural language understanding and generation

Key features:
- Titan Embeddings V2 for high-quality embedding vector generation
- Nova Pro for advanced text generation and RAG applications
...
```
    ...
    2026-02-03 14:57:01,150 - INFO - Successfully created Bedrock embeddings client
...
```
    ...
    2026-02-03 14:57:01,164 - INFO - Successfully created vector store
...
```
    ...
    2026-02-03 14:57:04,427 - INFO - Successfully loaded the BBC News dataset with 2687 rows.
...
```
    ...
    2026-02-03 15:08:31,585 - INFO - Document ingestion completed successfully.
...
```
    ...
    2026-02-03 15:08:31,595 - INFO - Successfully created cache
...
```
    ...
    2026-02-03 15:08:31,703 - INFO - Successfully created Bedrock LLM client with Nova Pro
...
```
    ...
    2026-02-03 15:08:32,032 - INFO - Semantic search completed in 0.33 seconds
...
```
    ...
    2026-02-03 15:08:32,038 - INFO - Successfully created RAG chain
...
```
    ...
    RAG Response: In his recent PDC World Championship match, Luke Littler achieved several notable records and milestones:
    
    1. **Tournament Record Average**: Littler hit a tournament record 140.91 set average during his 3-1 win over Ryan Meikle.
    2. **Maximum 180s**: He hit four maximum 180s in the fourth set.
    3. **Nearly a Nine-Darter**: Littler was millimetres away from achieving a nine-darter when he missed double 12.
    4. **Emotional Victory**: The match was so intense that Littler was overcome with emotion, cutting short his on-stage interview.
    5. **Rankings**: Starting the year ranked 164th, Littler has risen to fourth in the world rankings.
    6. **Prize Money and Titles**: He has won 10 titles in his debut professional year, including the Premier League and Grand Slam of Darts, and has earned over £1 million in prize money.
    
    For more detailed information, please refer to the provided context documents.
    RAG response generated in 2.33 seconds
...
```
    ...
    Response: In the match between Fulham and Liverpool, both teams delivered strong performances, resulting in a 2-2 draw at Anfield. Liverpool played the majority of the game with ten men after Andy Robertson received a red card in the 17th minute. Despite the numerical disadvantage, Liverpool managed to equalize twice, with the final goal coming from Diogo Jota in the 86th minute. Fulham's Antonee Robinson praised Liverpool's performance, noting that it didn't feel like they were playing with ten men. Liverpool's head coach, Arne Slot, described the team's performance as "impressive" under the circumstances. For more detailed insights and analysis, you can refer to the provided context documents.
    ...
    Response: In his recent PDC World Championship match, Luke Littler achieved several notable records and milestones:
...
You've built a semantic search engine using Couchbase Search Vector Index with Amazon Bedrock and LangChain. For the Hyperscale/Composite Vector Index alternative, see the [query_based tutorial](https://developer.couchbase.com/tutorial-aws-bedrock-couchbase-rag-with-hyperscale-or-composite-vector-index).
