...
[View Source](https://github.com/couchbase-examples/vector-search-cookbook/tree/main/cohere/search_based/RAG_with_Couchbase_and_Cohere.ipynb)
...
In this guide, we will walk you through building a powerful semantic search engine using Couchbase as the backend database and [Cohere](https://cohere.com/)
 as the AI-powered embedding and language model provider. Semantic search goes beyond simple keyword matching by understanding the context and meaning behind the words in a query, making it an essential tool for applications that require intelligent information retrieval. This tutorial is designed to be beginner-friendly, with clear, step-by-step instructions that will equip you with the knowledge to create a fully functional semantic search system using the Search Vector Index from scratch. Alternatively if you want to perform semantic search using the Hyperscale or Composite Vector Index, please take a look at [this.](https://developer.couchbase.com/tutorial-cohere-couchbase-rag-with-hyperscale-or-composite-vector-index/)

## How to run this tutorial

This tutorial is available as a Jupyter Notebook (`.ipynb` file) that you can run interactively. You can access the original notebook [here](https://github.com/couchbase-examples/vector-search-cookbook/blob/main/cohere/search_based/RAG_with_Couchbase_and_Cohere.ipynb).
...
```
    ...
    2026-02-03 11:37:42,145 - INFO - Successfully connected to Couchbase
...
```
    ...
    2026-02-03 11:37:43,340 - INFO - Bucket 'vector-search-testing' exists.
    2026-02-03 11:37:44,583 - INFO - Collection 'cohere' already exists. Skipping creation.
    2026-02-03 11:37:48,486 - INFO - Primary index present or created successfully.
    2026-02-03 11:37:48,827 - INFO - All documents cleared from the collection.
    2026-02-03 11:37:48,828 - INFO - Bucket 'vector-search-testing' exists.
    2026-02-03 11:37:49,883 - INFO - Collection 'cache' does not exist. Creating it...
    2026-02-03 11:37:51,141 - INFO - Collection 'cache' created successfully.
    2026-02-03 11:37:55,849 - INFO - Primary index present or created successfully.
    2026-02-03 11:37:56,145 - INFO - All documents cleared from the collection.





    <couchbase.collection.Collection at 0x129825d30>
...
```
    ...
    2026-02-03 11:37:57,330 - INFO - Creating new index 'vector_search_cohere'...
    2026-02-03 11:37:58,268 - INFO - Index 'vector_search_cohere' successfully created/updated.
...
```
    ...
    2026-02-03 11:38:01,791 - INFO - Successfully created vector store
...
```
    ...
    2026-02-03 11:38:05,062 - INFO - Successfully loaded the BBC News dataset with 2687 rows.
...
```
    ...
    2026-02-03 11:39:12,705 - INFO - Document ingestion completed successfully.
...
```
    ...
    2026-02-03 11:39:30,394 - INFO - Successfully created cache
...
```
    ...
    2026-02-03 11:39:32,447 - INFO - Successfully created Cohere LLM with model command
...
```
    ...
    2026-02-03 11:39:36,849 - INFO - Semantic search completed in 1.64 seconds


    
    Semantic Search Results (completed in 1.64 seconds):
    --------------------------------------------------------------------------------
    ...
    --------------------------------------------------------------------------------
    Score: 0.4965, Text: Liverpool boss Arne Slot says his Liverpool side "came close to perfection" in their win against Manchester City.
...
```
    ...
    2026-02-03 11:39:39,734 - INFO - Successfully created RAG chain
...
```
    ...
    RAG Response: Manchester City manager Pep Guardiola has expressed concern and frustration over the team's current form, which has been described as a "crisis." Guardiola has admitted that the poor run of results has affected his sleep and diet, and he has been quoted as saying that his state of mind is "ugly." He has also acknowledged that the team needs to defend better and avoid making mistakes at both ends of the pitch.
    
    In response to the team's struggles, Guardiola has emphasized the need to bring players back from injury and has stated that the solution is to focus on the next game without thinking too far ahead. He has also highlighted the importance of staying positive and trusting in the players' pride and desire to turn things around.
    
    Guardiola has taken responsibility for the team's performance, stating that he is "not good enough" to resolve the current situation. He has also acknowledged that the team needs to undergo a significant rebuild, with changes likely to be made in the summer transfer window.
    
    Overall, Guardiola's reaction to Manchester City's current form has been one of concern, self-reflection, and determination to find solutions to the team's problems.
    RAG response generated in 9.32 seconds
...
You've built a semantic search engine using Couchbase Search Vector Index with Cohere and LangChain. For the Hyperscale/Composite Vector Index alternative, see the [query_based tutorial](https://developer.couchbase.com/tutorial-cohere-couchbase-rag-with-hyperscale-or-composite-vector-index).
