---
# frontmatter
path: "/tutorial-openrouter-deepseek-with-search-vector-index"
title: RAG with DeepSeek using Couchbase Search Vector Index
short_title: RAG with DeepSeek using Couchbase Search Vector Index
description:
  - Learn how to build a semantic search engine using Couchbase and OpenRouter with Deepseek using Search Vector Index.
...
```
    ...
    2026-02-12 10:38:30,988 - INFO - Successfully connected to Couchbase
...
```
    ...
    2026-02-12 10:38:30,999 - INFO - Bucket 'vector-search-testing' exists.
    2026-02-12 10:38:31,002 - INFO - Collection 'deepseek' already exists. Skipping creation.
    2026-02-12 10:38:33,012 - INFO - Primary index present or created successfully.
    2026-02-12 10:38:33,064 - INFO - All documents cleared from the collection.
    2026-02-12 10:38:33,065 - INFO - Bucket 'vector-search-testing' exists.
    2026-02-12 10:38:33,066 - INFO - Collection 'cache' already exists. Skipping creation.
    2026-02-12 10:38:35,075 - INFO - Primary index present or created successfully.
    2026-02-12 10:38:35,078 - INFO - All documents cleared from the collection.





    <couchbase.collection.Collection at 0x14173c620>
...
```
    ...
    2026-02-12 10:38:35,099 - INFO - Creating new index 'vector_search_deepseek'...
    2026-02-12 10:38:35,113 - INFO - Index 'vector_search_deepseek' successfully created/updated.
...
```
    ...
    2026-02-12 10:38:35,252 - INFO - Successfully created OpenAI embeddings client
...
```
    ...
    2026-02-12 10:38:35,264 - INFO - Successfully created vector store
...
```
    ...
    2026-02-12 10:38:39,263 - INFO - Successfully loaded the BBC News dataset with 2687 rows.
...
```
    ...
    2026-02-12 10:39:17,525 - INFO - Document ingestion completed successfully.
...
```
    ...
    2026-02-12 10:39:17,537 - INFO - Successfully created cache
...
```
    ...
    2026-02-12 10:39:17,561 - INFO - Successfully created Deepseek LLM client through OpenRouter
...
```
    ...
    2026-02-12 10:39:17,842 - INFO - Semantic search completed in 0.28 seconds


    
    Semantic Search Results (completed in 0.28 seconds):
    --------------------------------------------------------------------------------
    Score: 0.6306, Text: The Littler effect - how darts hit the bullseye
    ...
    --------------------------------------------------------------------------------
    Score: 0.5981, Text: Luke Littler is one of six contenders for the 2024 BBC Sports Personality of the Year award.
    ...
    --------------------------------------------------------------------------------
    Score: 0.5403, Text: Second seed Smith knocked out of Worlds by Doets
    ...
    --------------------------------------------------------------------------------
    Score: 0.5329, Text: Cross loses as record number of seeds out of Worlds
    ...
    --------------------------------------------------------------------------------
    Score: 0.5118, Text: Michael van Gerwen has made just one major ranking event final in 2024
    ...
    --------------------------------------------------------------------------------
    Score: 0.5114, Text: Gary Anderson was the fifth seed to be beaten on Sunday
    ...
    --------------------------------------------------------------------------------
    Score: 0.5106, Text: Christian Kist was sealing his first televised nine-darter
...
```
    ...
    2026-02-12 10:39:17,847 - INFO - Successfully created RAG chain
...
```
    ...
    1.  **Tournament Record Average:** He hit a tournament record **set average of 140.91** during the fourth and final set of the match.
    2.  **Near-Perfect Set:** In that same fourth set, he won three consecutive legs in 11, 10, and 11 darts, completing the set in just 32 darts (the minimum possible is 27).
    3.  **Near-Nine-Darter:** He was "millimetres away" from achieving a nine-dart finish, narrowly missing double 12 on two separate occasions during the match.
    4.  **Victory:** He won the match with a score of 3-1 to advance to the next round.
    RAG response generated in 11.62 seconds
...
```
    ...
    Response: In the match between Fulham and Liverpool, Liverpool played with 10 men for the majority of the game after Andy Robertson received a red card in the 17th minute. Despite the numerical disadvantage, Liverpool twice came from behind to secure a 2-2 draw. Diogo Jota scored an 86th-minute equalizer to earn Liverpool a point. Fulham's Antonee Robinson commented that Liverpool played so well it "didn't feel like they had 10 men at all." Liverpool manager Arne Slot praised his team's character and described their performance as "outstanding" in the face of adversity.
...
You've built a semantic search engine using Couchbase Search Vector Index with OpenRouter DeepSeek and LangChain. For the Hyperscale/Composite Vector Index alternative, see the [query_based tutorial](https://developer.couchbase.com/tutorial-openrouter-deepseek-with-hyperscale-or-composite-vector-index).
