...
sdk_language:
  - python
length: 60 Mins
alt_paths: ["/tutorial-openrouter-deepseek-with-hyperscale-vector-index", "/tutorial-openrouter-deepseek-with-composite-vector-index"]
---
...
[View Source](https://github.com/couchbase-examples/vector-search-cookbook/tree/main/openrouter-deepseek/query_based/RAG_with_Couchbase_and_Openrouter_Deepseek.ipynb)
...
You've built a high-performance semantic search engine using Couchbase Hyperscale/Composite indexes with OpenRouter DeepSeek and LangChain. For the Search Vector Index alternative, see the [search_based tutorial](https://developer.couchbase.com/tutorial-openrouter-deepseek-with-search-vector-index).
