...
description:
  ...
  - This tutorial walks through configuring Keycloak, then covers both the Non-DCR flow with a pre-registered client and the DCR flow where clients register themselves dynamically.
  - You will publish a Protected Resource Metadata document, enable anonymous dynamic client registration in Keycloak, and verify each flow end to end using different IDEs.
...
[View Source](https://github.com/couchbase-examples/mcp-cookbook/tree/main/mcp_auth_keycloak_nondcr_and_dcr/mcp_auth_keycloak_nondcr_and_dcr.ipynb)

# Securing Couchbase MCP Server with Keycloak — Non-DCR and DCR Flows

This tutorial showcases how to set-up the Couchbase MCP server in Streamable HTTP mode with OAuth settings so that it serves clients that operate in the Browser flow (DCR and Non-DCR) using [Keycloak](https://www.keycloak.org/) as the identity provider:
...
⚠️ `start-dev` mode is for development only — it uses an in-memory database and is not suitable for production. For production deployments, see [Keycloak's production configuration guide](https://www.keycloak.org/server/configuration-production).
...
<img src="https://github.com/couchbase-examples/mcp-cookbook/blob/main/mcp_auth_keycloak_nondcr_and_dcr/keycloak_screenshots/key_1.png?raw=true" width="500">
...
<img src="https://github.com/couchbase-examples/mcp-cookbook/blob/main/mcp_auth_keycloak_nondcr_and_dcr/keycloak_screenshots/key_2.png?raw=true" width="500">
...
<img src="https://github.com/couchbase-examples/mcp-cookbook/blob/main/mcp_auth_keycloak_nondcr_and_dcr/keycloak_screenshots/key_3.png?raw=true" width="500">

### Step 1.3 — Register Couchbase MCP Server as a Resource Server in Keycloak

> ℹ️ **Keycloak's "Client" terminology:** In Keycloak, everything is called a "Client" — both the application requesting tokens (the OAuth client) and the API being protected (the resource server). This step creates a Keycloak Client that represents the resource server — i.e. the Couchbase MCP server itself. Its purpose is to define the audience (`aud` claim) and the scopes that tokens must carry to access it. This is different from the OAuth client you'll create in Step 2.1, which represents the browser-based application that actually requests tokens. See [Keycloak Client concepts](https://www.keycloak.org/docs/latest/server_admin/#_clients) for more.
...
<img src="https://github.com/couchbase-examples/mcp-cookbook/blob/main/mcp_auth_keycloak_nondcr_and_dcr/keycloak_screenshots/key_4.png?raw=true" width="500">

<img src="https://github.com/couchbase-examples/mcp-cookbook/blob/main/mcp_auth_keycloak_nondcr_and_dcr/keycloak_screenshots/key_5.png?raw=true" width="500">

<img src="https://github.com/couchbase-examples/mcp-cookbook/blob/main/mcp_auth_keycloak_nondcr_and_dcr/keycloak_screenshots/key_6.png?raw=true" width="500">
...
<img src="https://github.com/couchbase-examples/mcp-cookbook/blob/main/mcp_auth_keycloak_nondcr_and_dcr/keycloak_screenshots/key_10.png?raw=true" width="500">
...
<img src="https://github.com/couchbase-examples/mcp-cookbook/blob/main/mcp_auth_keycloak_nondcr_and_dcr/keycloak_screenshots/key_11.png?raw=true" width="500">

<img src="https://github.com/couchbase-examples/mcp-cookbook/blob/main/mcp_auth_keycloak_nondcr_and_dcr/keycloak_screenshots/key_7.png?raw=true" width="500">
...
- Web origins (needed for MCP Inspector's browser-based CORS requests):
  ...
  - `http://127.0.0.1:6274`
- **Save**
- Go to **Settings** tab → scroll to **Require PKCE** → toggle **On** → **Save** — this enforces PKCE for all authorization requests from this client, which is best practice for public clients per [OAuth 2.0 Security Best Current Practice](https://datatracker.ietf.org/doc/html/rfc9700#section-2.1.1). MCP Inspector and VS Code both support PKCE natively.
- **Client Scopes** tab → add `couchbase-mcp:read` and `couchbase-mcp:write` as **Default**

<img src="https://github.com/couchbase-examples/mcp-cookbook/blob/main/mcp_auth_keycloak_nondcr_and_dcr/keycloak_screenshots/key_15.png?raw=true" width="500">

<img src="https://github.com/couchbase-examples/mcp-cookbook/blob/main/mcp_auth_keycloak_nondcr_and_dcr/keycloak_screenshots/key_22.png?raw=true" width="500">

<img src="https://github.com/couchbase-examples/mcp-cookbook/blob/main/mcp_auth_keycloak_nondcr_and_dcr/keycloak_screenshots/key_37.png?raw=true" width="500">

<img src="https://github.com/couchbase-examples/mcp-cookbook/blob/main/mcp_auth_keycloak_nondcr_and_dcr/keycloak_screenshots/key_16.png?raw=true" width="500">
...
<img src="https://github.com/couchbase-examples/mcp-cookbook/blob/main/mcp_auth_keycloak_nondcr_and_dcr/keycloak_screenshots/key_17.png?raw=true" width="500">

<img src="https://github.com/couchbase-examples/mcp-cookbook/blob/main/mcp_auth_keycloak_nondcr_and_dcr/keycloak_screenshots/key_18.png?raw=true" width="500">
...
<img src="https://github.com/couchbase-examples/mcp-cookbook/blob/main/mcp_auth_keycloak_nondcr_and_dcr/keycloak_screenshots/key_19.png?raw=true" width="500">

<img src="https://github.com/couchbase-examples/mcp-cookbook/blob/main/mcp_auth_keycloak_nondcr_and_dcr/keycloak_screenshots/key_20.png?raw=true" width="500">

<img src="https://github.com/couchbase-examples/mcp-cookbook/blob/main/mcp_auth_keycloak_nondcr_and_dcr/keycloak_screenshots/key_21.png?raw=true" width="500">

<img src="https://github.com/couchbase-examples/mcp-cookbook/blob/main/mcp_auth_keycloak_nondcr_and_dcr/keycloak_screenshots/key_24.png?raw=true" width="500">
...
Dynamic Client Registration (DCR) allows MCP clients to register themselves with Keycloak at connection time without any manual pre-configuration. The client sends a registration request to Keycloak's `/clients-registrations/openid-connect` endpoint, receives a `client_id` back, and immediately uses it to start the authorization code flow. This is defined in [RFC 7591](https://datatracker.ietf.org/doc/html/rfc7591) and [Keycloak's DCR documentation](https://www.keycloak.org/securing-apps/client-registration). By default Keycloak locks down DCR — you need to configure it to allow anonymous registration.
...
<img src="https://github.com/couchbase-examples/mcp-cookbook/blob/main/mcp_auth_keycloak_nondcr_and_dcr/keycloak_screenshots/key_36.png?raw=true" width="500">
...
<img src="https://github.com/couchbase-examples/mcp-cookbook/blob/main/mcp_auth_keycloak_nondcr_and_dcr/keycloak_screenshots/key_29.png?raw=true" width="500">

<img src="https://github.com/couchbase-examples/mcp-cookbook/blob/main/mcp_auth_keycloak_nondcr_and_dcr/keycloak_screenshots/key_30.png?raw=true" width="500">
...
<img src="https://github.com/couchbase-examples/mcp-cookbook/blob/main/mcp_auth_keycloak_nondcr_and_dcr/keycloak_screenshots/key_32.png?raw=true" width="500">
...
<img src="https://github.com/couchbase-examples/mcp-cookbook/blob/main/mcp_auth_keycloak_nondcr_and_dcr/keycloak_screenshots/key_33.png?raw=true" width="500">

<img src="https://github.com/couchbase-examples/mcp-cookbook/blob/main/mcp_auth_keycloak_nondcr_and_dcr/keycloak_screenshots/key_34.png?raw=true" width="500">

Ask the chat to use one of the MCP tools to validate.


<img src="https://github.com/couchbase-examples/mcp-cookbook/blob/main/mcp_auth_keycloak_nondcr_and_dcr/keycloak_screenshots/key_35.png?raw=true" width="500">
